...
def user_input(user_question):
    ...
    with open("faiss_store.pkl", "rb") as f:
        vector_store = pickle.load(f, allow_dangerous_deserialization=True)
    
    # Load the index
    vector_store.index = FAISS.load_local("faiss.index", embeddings, allow_dangerous_deserialization=True)
